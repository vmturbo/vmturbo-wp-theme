<?php
/**
 * Template Name: Temporary - VMWorld Sweepstakes
 */
?>
<style type="text/css">
.wrap.container-fluid {
		background:url('http://vmturbo.com/wp-content/uploads/2016/04/mandalay-dark-blur.jpg') fixed no-repeat top center;
...
<div class="container">
	<div style="margin:9em 0;text-align:center;color:#fff;">
			<img src="http://vmturbo.com/wp-content/uploads/2016/04/vmworld-2016.png" style="margin-bottom:2em" />
	<div class="row">
	...
	<div class="row">
			...
			<div><a class="" role="button" data-toggle="collapse" href="#collapse" aria-expanded="false" aria-controls="collapse" style="color:#ccc;letter-spacing:1px;font-size:.9em;margin-top:3em;text-transform:uppercase;display:inline-block">Learn More <span class="glyphicon glyphicon-triangle-bottom" aria-hidden="true" style="font-size:.9em"></span></a></div>
				<div class="collapse" id="collapse">
				  <div style="text-align: left;padding: 2em;margin: 2em 2em 0;border-top: 3px solid #222;">
					<p>Do you want to attend VMworld<sup>&reg;</sup> 2016 US in Las Vegas this year, but your company won’t pay for the conference passes? Try your luck and win two full conference passes to VMworld<sup>&reg;</sup> on VMTurbo<sup>&reg;</sup>.</p>
					<h3>How can you participate?</h3>
					<p>It's easy. Fill out the form on this page. Cross your fingers.</p>
					<p>You'll be entered into all three drawings. You only have to enter once.</p>
					<h3>What are the rules?</h3>
					<p>It is open to everyone 18 years of age or older at the time of entry. Winners must be present in Las Vegas during VMworld<sup>&reg;</sup> in order to claim passes.</p>
					<p>Sweepstakes starts May 4, 2016 and ends on July 15, 2016 at 11:59PM EST. Winners will be announced on the same day of each drawing and we will notify each winners by email.</p>
					<h3>When will the drawings take place?</h3>
						<ul>
							<li>May 27, 2016</li>
							<li>June 17, 2016</li>
							<li>July 15, 2016</li>
						</ul>
					<h3>Where can I learn more about VMTurbo<sup>&reg;</sup>?</h3>
					<p><a href="http://vmturbo.com" style="color:#ccc;font-weight:600;">Click here to learn more about VMTurbo<sup>&reg;</sup>.</a></p>
					<h3>Terms & Conditions</h3>
					<p>This promotion is valid from May 4, 2015 to July 15, 2016 at 11:59PM EST.</p>
					<p><a href="http://vmturbo.com/2016-vmturbo-vmworld-sweepstakes-terms-and-conditions/" style="color:#ccc;font-weight:600;" target="_blank">Read the full Terms and Conditions here.</a></p>
				  </div>
				</div>
		</div>
		</div>
		...
		<ul id="vm-winners" style="width:100%;text-align:center;font-size:1.3em;display:none;">
			...
			<li class="wm-out"><a href="//fast.wistia.net/embed/iframe/zrb3741wsn?popover=true" class="wistia-popover[height=450,playerColor=7b796a,width=800]" style="  color:#FFF271;font-weight: bold;">WINNER #3</a></li>
		</ul>
	</div>
</div>
